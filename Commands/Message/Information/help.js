...
module.exports = {
  ...
  run: async (client, message, args, prefix) => {
    ...
    let help_embed = new MessageEmbed()
      ...
      .setDescription(" • Prefix for this server is `b$`\n• Total commands: 78\n• [Invite](https://discord.com/api/oauth2/authorize?client_id=1148114016556810240&permissions=36423889579222&scope=bot) | [Join](https://discord.gg/BsdfHF6r2M)\n > 🤴 **__My Categories are__** :\n\n >>>   🏠  Home\n📺  Channel\n😄  Fun\n🎮   Games\nℹ️   Information\n🆙  Level\n🛠️  Moderation\n🎵  Music\n⚙️  Settings\n🔧  Utility")
      .addField("🤴 **__STATS:__**",
                  ...
                  new MessageEmbed()
                    ...
                    .setDescription(
                      `>>> ${client.mcommands
                        ...
                        .map((cmd) => {
                          return `b$ ** ${cmd.name}** → ${cmd.description} \n`;
                        })
                        .join("")}`
                    )
